...
namespace Modelos
{
    public class Productos
    {
        ...
        public Productos(int productID, int unitsInStock)
        {
            ProductID = productID;
        ...
        public Productos(int productID, string productName, double unitPrice, int unitsInStock)
        {
            ProductID = productID;
            ProductName = productName;
            UnitPrice = unitPrice;
        ...
        public Productos(string productname, double cantidadapedir)
        {
